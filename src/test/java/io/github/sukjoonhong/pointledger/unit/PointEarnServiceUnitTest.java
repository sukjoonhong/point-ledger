...
class PointEarnServiceUnitTest {
    ...
    void earnAmountExceedsSingleLimit() {
        ...
        PointTransaction tx = PointTransaction.builder().amount(100001L).type(PointTransactionType.EARN).build();

        assertThatThrownBy(() -> PointAsset.createActiveAsset(wallet, tx, 1L, 100000L, 30))
